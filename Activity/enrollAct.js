...
export default function enrollAct({navigation,route}) {
    ...
    return (
        <View style={styles.container}  >
            ...
            <TextInput style={[styles.textInput,]} placeholder='人數' value={people} onChangeText={text=> {setPeople(text); setTotal(route.params.act_name.fields.act_price*text)}}/>
