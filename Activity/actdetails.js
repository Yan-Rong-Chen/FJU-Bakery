    ...
    <View style={{flex: 1}} >
      <ScrollView style={{flex: 1, height: height}} contentContainerStyle={styles.detailContainer}>
        <Image 
          ...
          source={{ uri: route.params.act_pic[0].url }} 
        />
        <View style={styles.detailText} >
            <Text style={styles.itemTitle}>{route.params.act_name}</Text>
            <Text style={styles.detailDesc}>已報名人數：0/{route.params.act_limit}</Text>
            <Text style={styles.detailDesc}>日期：{route.params.act_date}</Text>
            <Text style={styles.detailPrice}>價格：${route.params.act_price}/人</Text>
            <Text style={styles.detailDesc}>活動內容：{"\n"}{route.params.act_content}</Text>
